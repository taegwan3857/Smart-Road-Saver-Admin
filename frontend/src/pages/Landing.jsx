  ...
  <div className="landing-container">
   ...
   <section className="full-screen-section" id="application" style={{backgroundColor: "#ffffff"}}>
    <div className="section-inner">
     ...
     <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '30px', padding: '20px 0'}} className="fade-up d1">
   ...
   <section className="qa-section full-screen-section" id="team" style={{backgroundColor: "#ffffff"}}>
    ...
    <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px', maxWidth: '1000px', width: '100%', margin: '20px auto 0'}} className="fade-up d1">
     
     <div style={{background: '#f8fafc', borderRadius: '24px', padding: '48px 32px', textAlign: 'center', border: '1px solid #e2e8f0', boxShadow: '0 10px 40px rgba(0,0,0,0.02)'}}>
