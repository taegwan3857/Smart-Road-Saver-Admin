    ...
    <div className="login-page">
      <div className="login-card-split">
        <div className="login-left">
          <img src={logoImg} alt="Smart Road Saver Logo" style={{height: "56px", marginBottom: "24px", marginLeft: "-8px", alignSelf: "flex-start", filter: "brightness(0) invert(1) opacity(0.8)"}} />
        ...
        <div className="login-right">
          ...
          <div className="login-warning">
            ...
            <div>
              <strong>시스템 접근 제한 안내</strong>
              <p>본 시스템은 인가된 관리자만 접근할 수 있습니다.<br />무단 접근 시 관련 법령에 의해 처벌받을 수 있습니다.</p>
            </div>
          </div>
        </div>
      </div>
