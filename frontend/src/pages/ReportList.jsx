      ...
      <div className="panel">
        ...
        <div className="table-responsive">
          <table className="data-table">
            ...
            <tbody>
              {isLoading ? (
                <tr><td colSpan="7" style={{textAlign:"center",padding:"40px",color:"var(--text-light)"}}></td></tr>
              ) : filteredItems.length === 0 ? (
                <tr><td colSpan="7" style={{textAlign:"center",padding:"40px",color:"var(--text-light)"}}>신고 문서가 없습니다.</td></tr>
                                          ) : currentItems.map((r) => (
