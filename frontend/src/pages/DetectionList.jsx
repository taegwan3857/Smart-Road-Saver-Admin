      ...
      <div className="panel">
        ...
        <div className="table-responsive">
          <table className="data-table">
            ...
            <tbody>
              {isLoading ? (
                <tr><td colSpan="9" style={{textAlign:"center",padding:"40px",color:"var(--text-light)"}}></td></tr>
              ) : filteredItems.length === 0 ? (
                <tr><td colSpan="9" style={{textAlign:"center",padding:"40px",color:"var(--text-light)"}}>감지 기록이 없습니다.</td></tr>
              ) : currentItems.map((d) => (
